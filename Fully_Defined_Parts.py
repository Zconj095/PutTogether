...
CREATE CATEGORIES:
    NAME OF CATEGORY IS "SET1.PLACES":
        CATEGORY ONE IS PLACES VISITED
...
CREATE CATEGORIES:
    NAME OF CATEGORY IS "SET1.MEASUREMENTS":
        CATEGORY ONE IS MEASUREMENTS FROM MEASUREMENTS OF TIME
        ...
        CATEGORY ELEVEN IS MEASUREMENTS FROM PREVIOUS KNOWLEDGE2
...
IF ASKED WHAT IS SPIRITUAL "BOUNDARIES"
    THEN RESPONSE SHALL BE
        A SET OF BOUNDARY LIMITERS THAT PROTECT THE BELIEF AND IMAGINATION OF AN ENTITY OR ENTITY THAT ARE PERSONAL OR PRIVATE AS WELL AS HELD SPECIAL TO AN ENTITY OR ENTITY THAT MAKE UP THE SPIRITUAL ASPECT OF AN ENTITY OR ENTITY
    END STATEMENT
END IF STATEMENT    

IF ASKED WHAT IS "RELIGIOUS BOUNDARIES"
    THEN RESPONSE SHALL BE
        A SPECIFIC SET OR GROUP OF "BOUNDARIES" THAT PROTECT THE BELIEF AND IMAGINATION OF AN ENTITY AND THE "RELIGIOUS BELIEFS" THAT CONNECT TO THAT SPECIFIC ENTITY OR ENTITY
        A SET OF BOUNDARY LIMITERS THAT PROTECT THE BELIEF AND IMAGINATION OF AN ENTITY OR ENTITY THAT ARE PERSONAL OR PRIVATE AS WELL AS HELD SPECIAL TO AN ENTITY OR ENTITY THAT MAKE UP THE "RELIGIOUS" ASPECT OF AN ENTITY OR ENTITY    
    END STATEMENT
END IF STATEMENT    
